    ...
    <div className="applied-candidates-container">
      <div className="widget-title d-flex justify-content-between align-items-center">
        <div className="title-area">
          <h4 className="text-2xl font-semibold bg-gradient-brand bg-clip-text text-transparent m-0">Applied Candidates <span className="badge bg-primary">{appliedCandidates.length}</span></h4>
