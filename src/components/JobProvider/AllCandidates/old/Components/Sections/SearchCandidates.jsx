    ...
    <div className="search-candidates-container">
      <div className="widget-title d-flex justify-content-between align-items-center">
        <div className="title-area">
          {filtersApplied ? (
            <h4 className="text-2xl font-semibold bg-gradient-brand bg-clip-text text-transparent m-0">Filtered Candidates <span className="badge bg-primary">{filtered.length}</span></h4>
          ) : (
            <h4 className="text-2xl font-semibold bg-gradient-brand bg-clip-text text-transparent m-0">Search Candidates</h4>
          )}
        </div>
