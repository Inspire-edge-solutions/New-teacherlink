...
const ChatInput = ({ onSendMessage, disabled = false, onTyping }) => {
  ...
  return (
    <div className="bg-white border-t border-gray-200 px-3 sm:px-6 py-3 sm:py-4">
      {/* Connection Status */}
      {disabled && (
        <div className="mb-3 flex items-center justify-center gap-2 text-lg sm:text-base text-gray-500 leading-normal tracking-tight">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex-1">
          <input
            ...
            disabled={disabled}
            className={`w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-lg sm:text-base leading-normal tracking-tight ${
