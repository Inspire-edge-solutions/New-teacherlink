            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[80vh] flex flex-col">
              ...
              {blockedUsers.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-base">No blocked candidates</p>
                </div>
              ) : (
                  ...
                  {blockedUsers.map((blocked) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="text-base font-medium text-gray-900 leading-normal tracking-tight">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-base text-red-600 bg-white border border-red-300 rounded-md hover:bg-red-50 transition-colors flex items-center gap-1 leading-normal tracking-tight"
                      >
                        <FiUnlock size={14} />
                        <span>Unblock</span>
                      </button>
      ...
      <div className="flex-1 overflow-y-auto">
              ...
              <div className="px-4 py-3 border-b border-gray-100 flex-shrink-0">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-base leading-normal tracking-tight"
                  />
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto min-h-0">
                {isLoading ? (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="text-base font-medium text-gray-900 truncate leading-tight tracking-tight">
                  ...
                  <div className="p-4 text-center">
                    <p className="text-base text-gray-500 leading-normal tracking-tight">No unlocked candidates available. Unlock candidates to start messaging them.</p>
                  </div>
                )}
              </div>
            </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="relative flex-shrink-0">
                      <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                        <span className="text-blue-600 font-semibold text-base leading-normal tracking-tight">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1 text-base text-gray-500 leading-normal tracking-tight">
                          <FiClock size={12} />
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="relative flex-shrink-0">
                      <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                        <span className="text-gray-500 font-semibold text-base leading-normal tracking-tight">
                          {person.name?.charAt(0).toUpperCase() || 'U'}
                        </span>
                      </div>
                      {person.unreadCount > 0 && (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <h4 className="text-base font-medium text-gray-500 truncate leading-tight tracking-tight">
                          {person.name && !person.name.includes('undefined') && !person.name.startsWith('User ') && person.name !== 'Loading...'
                            ? person.name 
                            : 'Loading...'}
                        </h4>
                        <div className="flex items-center gap-1 text-base text-gray-400 leading-normal tracking-tight">
                          <FiClock size={12} />
                          <span>{formatLastMessageTime(person.lastMessageTime)}</span>
                        </div>
                      </div>
        ...
        {!isLoading && filteredPeople.length === 0 && filteredInactiveJobs.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center p-6">
            ...
            <p className="text-base text-gray-400 leading-normal tracking-tight">
              {searchQuery ? 'No conversations found' : 'No candidate conversations yet'}
            </p>
            {searchQuery && (
              <button 
                onClick={() => setSearchQuery('')}
                className="text-base text-red-500 mt-2 hover:underline"
              >
                Clear search
              </button>
            )}
