      ...
      <div className="flex items-center justify-between gap-2 sm:gap-3 mb-4 overflow-hidden">
        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-brand-text bg-clip-text text-transparent leading-tight tracking-tight truncate">Notifications</h1>
