          ...
          {jobs.length === 0 ? (
            ...
            <div className="text-center py-12">
              <div className="flex flex-col items-center justify-center">
                ...
                />
                <h6 className="text-xl font-semibold text-gray-700 mb-2 leading-tight tracking-tight">No Jobs Posted Yet</h6>
            ...
            <div className="w-full">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-5 gap-4 w-full">
                <h6 className="text-xl font-semibold text-gray-700 whitespace-nowrap leading-tight tracking-tight">Your Posted Jobs: {filteredJobs.length}</h6>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start gap-3 overflow-x-hidden">
                            ...
                            <div className="flex-1 min-w-0 flex flex-col items-start justify-center overflow-hidden">
                              ...
                              {job.is_closed === 1 && job.reason && (
                                <p className="text-base text-gray-600 mt-1 break-words sm:truncate w-full leading-normal tracking-tight" title={job.reason}>
