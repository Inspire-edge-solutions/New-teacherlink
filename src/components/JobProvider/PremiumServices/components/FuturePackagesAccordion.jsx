              ...
              <div className="px-3 py-3 sm:px-4 sm:py-4 md:px-5 md:py-4 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    {isExpanded ? (
                      <FaChevronUp className="text-gray-600 flex-shrink-0 text-base" />
                    ) : (
                      <FaChevronDown className="text-gray-600 flex-shrink-0 text-base" />
                    )}
                  </button>
                </div>
              </div>
                        ...
                        <div className="lg:col-span-3 flex flex-col">
                          <div className="px-4 py-4 sm:px-5 sm:py-5 md:px-6 md:py-5">
                            ...
                            <div className="mb-3 sm:mb-4 pb-3 sm:pb-4 text-center">
                              ...
                              <button
                                disabled
                                className="w-auto px-6 py-2 sm:px-7 sm:py-2.5 md:px-8 md:py-2.5 rounded-lg font-semibold text-base transition-all duration-200 flex items-center justify-center gap-2 bg-gray-400 text-white cursor-not-allowed shadow-lg mx-auto opacity-60 leading-normal tracking-tight"
                              >
