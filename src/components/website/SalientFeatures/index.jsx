      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <div className="bg-gradient-brand rounded-xl p-4 md:p-8 shadow-lg max-w-4xl mx-auto mb-12 md:mb-16">
            <p className="text-lg text-white leading-normal tracking-tight text-center">
          ...
          <div className="max-w-6xl mx-auto mb-12 md:mb-16 px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-4 md:mb-6">
              ...
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md">
                ...
                <p className="text-lg text-gray-600 text-left leading-normal tracking-tight">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="lg:col-span-2 bg-red-100 rounded-xl p-6 md:p-8 shadow-lg text-center">
                ...
                <p className="text-lg text-gray-700 mb-3 leading-normal tracking-tight">Join thousands of teachers who've found success with us.</p>
          ...
          <div className="max-w-6xl mx-auto mb-12 md:mb-16 px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="bg-white rounded-xl p-4 md:p-6 shadow-md">
                <div className="flex items-start mb-3">
                  <span className="text-red-600 text-xl md:text-2xl mr-2">🎯</span>
                  <h3 className="text-lg md:text-xl font-bold text-gray-800 leading-tight tracking-tight">Smart Matching System</h3>
                </div>
                <p className="text-lg text-gray-600 text-left leading-normal tracking-tight">
              ...
              <div className="lg:col-span-2 bg-red-100 rounded-xl p-6 md:p-8 shadow-lg text-center">
                ...
                <p className="text-lg text-gray-700 mb-3 leading-normal tracking-tight">Looking to fill teaching roles with top talent?</p>
