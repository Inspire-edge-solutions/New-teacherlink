    ...
    <div className="flex flex-wrap gap-2 border-b border-gray-200 pb-4">
      {filterOptions.map(({ key, label, icon, count }) => (
        <button
          ...
          className={`flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg transition-all duration-200 w-[calc(50%-0.25rem)] sm:w-auto text-base leading-normal tracking-tight ${
            filter === key
