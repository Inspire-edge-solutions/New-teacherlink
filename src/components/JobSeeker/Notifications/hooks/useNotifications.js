...
const mockNotifications = [
  {
    ...
    message: 'A new teaching position matches your profile: Mathematics Teacher at ABC School',
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000), // 2 hours ago
    read: false,
    link: '/seeker/all-jobs'
  },
  {
    id: 2,
    type: 'application',
    title: 'Application Status Update',
    message: 'Your application for Science Teacher at XYZ Institute has been viewed',
  ...
  },
  {
    ...
    type: 'message',
    title: 'New Message',
    message: 'You have a new message from ABC School regarding your application',
  ...
  },
  {
    ...
    message: 'Please complete your profile to increase your job match score',
  ...
  },
  {
    ...
    message: 'You have 3 saved jobs that match your preferences. Apply now!',
