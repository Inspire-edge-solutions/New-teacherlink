      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="w-full">
          <div className="flex items-center gap-2">
            <span className="text-gray-700 font-semibold text-base whitespace-nowrap leading-normal tracking-tight">Rs.</span>
            <div className="flex-1">
            ...
            <span className="text-gray-700 font-semibold text-base whitespace-nowrap leading-normal tracking-tight">{experience.jobCategory === "fullTime" ? "in LPA" : "per hour"}</span>
          </div>
        </div>
      </div>
